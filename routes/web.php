...
Route::get('/repayments/all', [App\Http\Controllers\RepaymentsController::class, 'index'])->name('repayments/all')->middleware('auth');
Route::post('/repayments/add', [App\Http\Controllers\RepaymentsController ::class, 'store'])->name('repayments/add')->middleware('auth');//repayment_Details
